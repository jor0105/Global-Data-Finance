...
Leia quando:
- o problema principal e decisao, densidade, feedback, confianca, carga cognitiva ou ordem de leitura
- voce precisa justificar porque uma interface parece confusa, lenta ou pouco confiavel

Extraia:
- leis de UX que expliquem o problema real
- limites praticos para opcoes, alcance, chunking e destaque
- sinais de confianca, reducao de friccao e risco cognitivo
- apenas os checks que mudam a solucao, sem transformar teoria em ornamento
- se a conversa virar traducao de emocao em paleta, tipografia ou tema, abra
  hand-off para `../../ui-ux/references/color-system.md`
...
## 6. Supplemental Persona Signals

Use job-to-be-done, experience level, device constraints, environment and trust needs antes de recorrer aos grupos abaixo. As cohortes demograficas servem como sinais fracos de tom e densidade quando nao existe pesquisa melhor.
...
## 7. Emotion To Visual-System Hand-off

Quando a conclusao psicologica precisar virar paleta, contraste, tipografia,
tema ou motion-base, consulte `../../ui-ux/references/color-system.md`
e os demais arquivos visuais do owner canônico.

Esta skill continua owner de:

- custo de decisao
- ordem de leitura
- carga cognitiva
- confianca e prova
- feedback e reducao de friccao
