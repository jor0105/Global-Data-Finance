...
description: >
  Use para gestão de servidor e runtime local/prod: processos, portas, health checks,
  workers, logs, monitoramento e scaling. Ative quando o usuário pedir "servidor não
  sobe", "configura workers", "healthcheck", "PM2/systemd/docker", "porta ocupada" ou
  preview operacional.
---
