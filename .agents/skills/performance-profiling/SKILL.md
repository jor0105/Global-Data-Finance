...
1. Descubra se o pedido ainda e de triagem cross-layer ou se o gargalo ja esta localizado:
   ...
   - se o usuario ja delimitou query lenta, indice, schema, Postgres ou Supabase, saia cedo para `database-design` ou `supabase-postgres-best-practices`
...
**Por que nao:** O problema ja esta no banco. Use `database-design` ou `supabase-postgres-best-practices`.
