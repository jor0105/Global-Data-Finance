...
Leia quando:
- voce quer adicionar acabamento visual, profundidade ou destaque sem cair em excesso
- o problema nao e estrutura da tela, e sim polish, atmosfera ou contraste visual

Extraia:
- um efeito principal com proposito claro
- limites de complexidade e custo de performance
- criterios para nao competir com conteudo, legibilidade e interacao
