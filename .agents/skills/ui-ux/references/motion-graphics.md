...
Leia quando:
- voce esta considerando motion avancado como Lottie, GSAP, SVG, 3D ou particulas
- o valor esperado e destaque premium, narrativa ou reforco de marca, nao apenas animar por animar

Extraia:
- se motion avancado e realmente justificavel
- fallback para mobile, reduced motion e cleanup de runtime
- limites de performance e manutencao antes de introduzir dependencia visual
