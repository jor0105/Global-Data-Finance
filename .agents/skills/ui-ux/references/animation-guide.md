...
- voce precisa decidir microinteracao, loading, transicao ou timing
- a interface precisa de feedback ou orientacao, nao apenas decoracao

Extraia:

- duracao e easing coerentes com contexto e importancia
- tratamento de loading e transicoes sem ruido
- requisitos de `prefers-reduced-motion` antes de sofisticar a experiencia
