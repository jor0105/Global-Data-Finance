...
Leia quando:
- voce precisa decidir escala, pairing, densidade tipografica ou legibilidade
- a tela parece plana, apertada, cansativa ou sem hierarquia de leitura

Extraia:
- base size e ratio adequados ao contexto
- direcao de pairing sem inventar fontes aleatorias
- line-height e line-length para leitura real
- regra de responsividade antes de microajustes cosmeticos
