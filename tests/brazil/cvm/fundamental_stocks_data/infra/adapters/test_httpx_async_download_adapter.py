...
class TestHttpxAsyncDownloadAdapterInitialization:
    def test_init_with_default_values(self):
        ...
        adapter = HttpxAsyncDownloadAdapterCVM(file_extractor_repository=mock_extractor)
    ...
    def test_init_with_custom_values(self):
        mock_extractor = MagicMock()
        adapter = HttpxAsyncDownloadAdapterCVM(
...
class TestHttpxAsyncDownloadAdapterHelpers:
    def test_extract_filename_normal_url(self):
        ...
        filename = HttpxAsyncDownloadAdapterCVM._extract_filename(url)
...
class TestHttpxAsyncDownloadAdapterDownloadDocs:
    @patch(
        "datafinc.brazil.cvm.fundamental_stocks_data.infra.adapters.requests.httpx_async_download_adapter.asyncio.run"
    )
...
class TestHttpxAsyncDownloadAdapterAsyncMethods:
    ...
    @patch(
        "datafinc.brazil.cvm.fundamental_stocks_data.infra.adapters.requests.httpx_async_download_adapter.remove_file"
    )
    ...
    @patch(
        "datafinc.brazil.cvm.fundamental_stocks_data.infra.adapters.requests.httpx_async_download_adapter.asyncio.sleep"
    )
...
class TestHttpxAsyncDownloadAdapterEdgeCases:
    def test_adapter_with_none_extractor(self):
        adapter = HttpxAsyncDownloadAdapterCVM(file_extractor_repository=None)
    ...
    def test_extract_filename_edge_cases(self):
        ...
        for url, expected in test_cases:
            result = HttpxAsyncDownloadAdapterCVM._extract_filename(url)
...
class TestHttpxAsyncDownloadAdapterDownloadDocsRepository:
    ...
    def test_can_be_used_as_download_repository(self):
        ...
        mock_extractor = MagicMock()
        adapter: DownloadDocsCVMRepositoryCVM = HttpxAsyncDownloadAdapterCVM(
            file_extractor_repository=mock_extractor
        )

        assert isinstance(adapter, HttpxAsyncDownloadAdapterCVM)
