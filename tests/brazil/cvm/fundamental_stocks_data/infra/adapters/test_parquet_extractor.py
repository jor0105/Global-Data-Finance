...
from datafinance.brazil.cvm.fundamental_stocks_data import ParquetExtractorAdapterCVM
...
class TestParquetExtractorErrorHandling:
    ...
    def test_extract_wraps_unexpected_exception(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(extractor, "_ParquetExtractorAdapterCVM__extract_with_transaction", mock_extract)
...
class TestParquetExtractorSuccessfulExtraction:
    ...
    def test_extract_nonexistent_zip_raises_error(self, tmp_path):
        ...
        with pytest.raises(ExtractionError):
            extractor.extract(str(nonexistent_zip))
