...
class TestGetAvailableYearsUseCaseB3:
    def test_get_atual_year_returns_current_year(self):
        use_case = GetAvailableYearsUseCaseB3()
    ...
    def test_can_instantiate_use_case(self):
        ...
        assert isinstance(use_case, GetAvailableYearsUseCaseB3)
    ...
    def test_multiple_instances_return_same_values(self):
        use_case1 = GetAvailableYearsUseCaseB3()
        use_case2 = GetAvailableYearsUseCaseB3()
