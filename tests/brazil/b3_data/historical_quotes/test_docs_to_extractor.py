...
class TestDocsToExtractor:
    def test_create_docs_to_extractor_with_all_fields(self):
        ...
        docs = DocsToExtractorB3(
            ...
            documents_to_download=set_documents,
        )
        ...
        assert docs.documents_to_download == set_documents
    ...
    def test_create_docs_to_extractor_with_default_documents(self):
        ...
        assert docs.documents_to_download == set()
    ...
    def test_docs_to_extractor_fields_are_mutable(self):
        ...
        docs.documents_to_download = {'new_doc.ZIP'}
        ...
        assert docs.documents_to_download == {'new_doc.ZIP'}
    ...
    def test_docs_to_extractor_with_large_document_set(self):
        ...
        assert len(docs.documents_to_download) == 39
        assert 'COTAHIST_A1986.ZIP' in docs.documents_to_download
        assert 'COTAHIST_A2024.ZIP' in docs.documents_to_download
