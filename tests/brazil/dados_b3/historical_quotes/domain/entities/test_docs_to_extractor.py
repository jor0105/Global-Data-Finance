...
class TestDocsToExtractor:
    ...
    def test_create_docs_to_extractor_with_default_documents(self):
        """Test creation with default empty set for documents."""
        # Arrange
        path_of_docs = "/path/to/docs"
        set_assets = {"ações"}
    ...
    def test_docs_to_extractor_with_empty_set_assets(self):
        """Test creation with empty set_assets."""
        # Arrange
        path_of_docs = "/path/to/docs"
        set_assets = set()
        range_years = range(2020, 2024)
    ...
    def test_docs_to_extractor_with_single_year_range(self):
        """Test creation with single year range."""
        # Arrange
        path_of_docs = "/path/to/docs"
        set_assets = {"ações"}
        range_years = range(2020, 2021)
    ...
    def test_docs_to_extractor_with_empty_range(self):
        """Test creation with empty year range."""
        # Arrange
        path_of_docs = "/path/to/docs"
        set_assets = {"ações"}
    ...
    def test_docs_to_extractor_is_dataclass(self):
        """Test that DocsToExtractor is a dataclass with expected behavior."""
        # Arrange
        path_of_docs = "/path/to/docs"
        set_assets = {"ações"}
        range_years = range(2020, 2024)
    ...
    def test_docs_to_extractor_with_special_characters_in_paths(self):
        """Test creation with special characters in paths."""
        # Arrange
    ...
    def test_docs_to_extractor_with_multiple_asset_classes(self):
        """Test creation with all available asset classes."""
        # Arrange
        path_of_docs = "/path/to/docs"
        set_assets = {
            "ações",
    ...
    def test_docs_to_extractor_with_large_document_set(self):
        """Test creation with large set of documents."""
        # Arrange
        path_of_docs = "/path/to/docs"
        set_assets = {"ações"}
    ...
    def test_docs_to_extractor_equality(self):
        """Test equality comparison between DocsToExtractor instances."""
        # Arrange
    ...
    def test_docs_to_extractor_inequality(self):
        """Test inequality comparison between different DocsToExtractor instances."""
        # Arrange
        docs1 = DocsToExtractor(
            path_of_docs="/path/to/docs",
            set_assets={"ações"},
