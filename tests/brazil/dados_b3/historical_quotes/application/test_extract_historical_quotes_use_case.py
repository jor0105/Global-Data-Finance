...
class TestExecuteAsyncMethod:
    @pytest.mark.asyncio
    @patch(
        "datafinance.brazil.dados_b3.historical_quotes.application.use_cases.extract_historical_quotes_use_case.ExtractionServiceFactory"
    )
    @patch(
        "datafinance.brazil.dados_b3.historical_quotes.application.use_cases.extract_historical_quotes_use_case.AvailableAssetsService"
    )
