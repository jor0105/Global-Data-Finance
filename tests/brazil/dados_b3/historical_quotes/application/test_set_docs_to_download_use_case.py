"""Tests for CreateSetToDownloadUseCase."""
...
class TestCreateSetToDownloadUseCase:
    """Test suite for CreateSetToDownloadUseCase."""
    ...
    def test_execute_returns_set(self, mock_file_system):
        ...
        # Act
        result = CreateSetToDownloadUseCase.execute(range(2020, 2021), "/path/to/docs")
    ...
    def test_execute_calls_validate_directory_path(self, mock_file_system):
        """Test that execute calls validate_directory_path."""
        # Arrange
        mock_instance = MagicMock()
        mock_instance.validate_directory_path.return_value = Path("/path/to/docs")
        ...
        # Act
        CreateSetToDownloadUseCase.execute(range(2020, 2021), "/path/to/docs")
    ...
    def test_execute_calls_find_files_by_years(self, mock_file_system):
        """Test that execute calls find_files_by_years."""
        # Arrange
        mock_instance = MagicMock()
        ...
        # Act
        CreateSetToDownloadUseCase.execute(year_range, "/path/to/docs")
    ...
    def test_execute_with_single_year(self, mock_file_system):
        """Test execute with single year range."""
        # Arrange
        mock_instance = MagicMock()
        mock_instance.validate_directory_path.return_value = Path("/path/to/docs")
        mock_instance.find_files_by_years.return_value = {"COTAHIST_A2020.ZIP"}
    ...
    def test_execute_with_multiple_years(self, mock_file_system):
        """Test execute with multiple years."""
        # Arrange
        mock_instance = MagicMock()
        mock_instance.validate_directory_path.return_value = Path("/path/to/docs")
        ...
        # Act
        result = CreateSetToDownloadUseCase.execute(range(2020, 2023), "/path/to/docs")
    ...
    def test_execute_returns_empty_set_when_no_files_found(self, mock_file_system):
        """Test that execute returns empty set when no files found."""
        # Arrange
        mock_instance = MagicMock()
        mock_instance.validate_directory_path.return_value = Path("/path/to/docs")
        mock_instance.find_files_by_years.return_value = set()
    ...
    def test_execute_with_long_year_range(self, mock_file_system):
        ...
        # Act
        result = CreateSetToDownloadUseCase.execute(range(1986, 2025), "/path/to/docs")
    ...
    def test_execute_with_path_containing_spaces(self, mock_file_system):
        ...
        # Act
        CreateSetToDownloadUseCase.execute(range(2020, 2021), path_with_spaces)
    ...
    def test_execute_with_empty_range(self, mock_file_system):
        """Test execute with empty year range."""
        # Arrange
        mock_instance = MagicMock()
        mock_instance.validate_directory_path.return_value = Path("/path/to/docs")
        mock_instance.find_files_by_years.return_value = set()
        ...
        # Act
        result = CreateSetToDownloadUseCase.execute(range(2020, 2020), "/path/to/docs")
    ...
    def test_execute_creates_file_system_service(self, mock_file_system):
        """Test that execute creates FileSystemService instance."""
        # Arrange
        mock_instance = MagicMock()
        mock_instance.validate_directory_path.return_value = Path("/path/to/docs")
        mock_instance.find_files_by_years.return_value = set()
    ...
    def test_execute_passes_validated_path_to_find_files(self, mock_file_system):
        """Test that validated path is passed to find_files_by_years."""
        # Arrange
        mock_instance = MagicMock()
        ...
        # Act
        CreateSetToDownloadUseCase.execute(year_range, "/original/path")
    ...
    def test_execute_returns_result_from_find_files(self, mock_file_system):
        """Test that execute returns result from find_files_by_years."""
        # Arrange
        mock_instance = MagicMock()
        mock_instance.validate_directory_path.return_value = Path("/path/to/docs")
        ...
        # Act
        result = CreateSetToDownloadUseCase.execute(range(2020, 2022), "/path/to/docs")
