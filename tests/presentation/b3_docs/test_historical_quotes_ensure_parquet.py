...
class TestEnsureParquetExtension:
    ...
    def test_does_not_duplicate_parquet_extension(self):
        ...
        hq = HistoricalQuotes()
        result = hq._HistoricalQuotes__ensure_parquet_extension("my_file.parquet")
        assert result == "my_file.parquet"
    ...
    def test_handles_filename_with_multiple_dots(self):
        ...
        hq = HistoricalQuotes()
        result = hq._HistoricalQuotes__ensure_parquet_extension("my.file.v2")
    ...
    def test_handles_filename_with_dots_and_parquet(self):
        ...
        hq = HistoricalQuotes()
        result = hq._HistoricalQuotes__ensure_parquet_extension("my.file.v2.parquet")
        assert result == "my.file.v2.parquet"

    def test_handles_empty_string(self):
        """Test with empty string - should add .parquet."""
        hq = HistoricalQuotes()
        result = hq._HistoricalQuotes__ensure_parquet_extension("")
...
class TestEnsureParquetExtensionRealWorldExamples:
    ...
    def test_example_user_already_provided_extension(self):
        ...
        hq = HistoricalQuotes()
        result = hq._HistoricalQuotes__ensure_parquet_extension("my_data.parquet")
