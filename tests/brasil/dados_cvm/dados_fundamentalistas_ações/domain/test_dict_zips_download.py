...
from src.brasil.dados_cvm.dados_fundamentalistas_ações.domain.dict_zips_download import (
    DictZipsToDownload,
)
...
class TestDictZipsToDownload:
    ...
    def test_get_dict_zips_to_download_returns_dict(self, dict_zips):
        result = dict_zips.get_dict_zips_to_download(["DFP"], 2020, 2020)
    ...
    def test_get_dict_zips_to_download_single_doc_multiple_years(self, dict_zips):
        result = dict_zips.get_dict_zips_to_download(["DFP"], 2020, 2022)
    ...
    def test_get_dict_zips_to_download_multiple_docs_single_year(self, dict_zips):
        result = dict_zips.get_dict_zips_to_download(["DFP", "ITR"], 2020, 2020)
    ...
    def test_get_dict_zips_to_download_multiple_docs_multiple_years(self, dict_zips):
        result = dict_zips.get_dict_zips_to_download(["DFP", "ITR"], 2020, 2021)
    ...
    def test_get_dict_zips_to_download_with_default_parameters(self, dict_zips):
        result = dict_zips.get_dict_zips_to_download()
    ...
    def test_get_dict_zips_to_download_with_only_list_docs(self, dict_zips):
        result = dict_zips.get_dict_zips_to_download(list_docs=["DFP"])
    ...
    def test_get_dict_zips_to_download_with_only_initial_year(self, dict_zips):
        result = dict_zips.get_dict_zips_to_download(initial_year=2020)
    ...
    def test_get_dict_zips_to_download_with_only_last_year(self, dict_zips):
        result = dict_zips.get_dict_zips_to_download(last_year=2020)
    ...
    def test_get_dict_zips_to_download_all_seven_docs(self, dict_zips):
        ...
        result = dict_zips.get_dict_zips_to_download(all_docs, 2020, 2020)
    ...
    def test_get_dict_zips_to_download_with_empty_list_docs(self, dict_zips):
        result = dict_zips.get_dict_zips_to_download([], 2020, 2020)
    ...
    def test_get_dict_zips_to_download_with_duplicate_docs(self, dict_zips):
        result = dict_zips.get_dict_zips_to_download(["DFP", "DFP"], 2020, 2020)
    ...
    def test_get_dict_zips_to_download_range_includes_boundaries(self, dict_zips):
        result = dict_zips.get_dict_zips_to_download(["DFP"], 2018, 2020)
    ...
    def test_get_dict_zips_to_download_with_minimum_year_2010(self, dict_zips):
        result = dict_zips.get_dict_zips_to_download(["DFP"], 2010, 2010)
    ...
    def test_get_dict_zips_to_download_large_year_range(self, dict_zips):
        result = dict_zips.get_dict_zips_to_download(["DFP"], 2010, 2024)
    ...
    def test_get_dict_zips_to_download_specific_url_structure_for_each_doc(
        ...
        result_dfp = dict_zips.get_dict_zips_to_download(["DFP"], 2020, 2020)
        assert "/DFP/DADOS/dfp_cia_aberta_2020.zip" in result_dfp["DFP"][0]

        result_itr = dict_zips.get_dict_zips_to_download(["ITR"], 2020, 2020)
        assert "/ITR/DADOS/itr_cia_aberta_2020.zip" in result_itr["ITR"][0]

        result_fre = dict_zips.get_dict_zips_to_download(["FRE"], 2020, 2020)
    ...
    def test_get_dict_zips_to_download_combinations(self, dict_zips):
        result1 = dict_zips.get_dict_zips_to_download(["DFP", "ITR", "FRE"], 2020, 2021)
        assert len(result1) == 3
        assert len(result1["DFP"]) == 2
        assert len(result1["ITR"]) == 2
        assert len(result1["FRE"]) == 2

        result2 = dict_zips.get_dict_zips_to_download(["DFP"], 2018, 2022)
        assert len(result2) == 1
        assert len(result2["DFP"]) == 5

        result3 = dict_zips.get_dict_zips_to_download(["DFP", "ITR"], 2020, 2020)
        assert len(result3) == 2
        assert len(result3["DFP"]) == 1
        assert len(result3["ITR"]) == 1

    @patch(
        "src.brasil.dados_cvm.dados_fundamentalistas_ações.domain.dict_zips_download.UrlDocs"
    )
    @patch(
        "src.brasil.dados_cvm.dados_fundamentalistas_ações.domain.dict_zips_download.AvailableYears"
    )
    def test_get_dict_zips_to_download_uses_dependencies_correctly(
        ...
        result = dict_zips_test.get_dict_zips_to_download(["DFP"], 2020, 2021)
    ...
    def test_get_dict_zips_to_download_result_is_new_list(self, dict_zips):
        result1 = dict_zips.get_dict_zips_to_download(["DFP"], 2020, 2020)
        result2 = dict_zips.get_dict_zips_to_download(["DFP"], 2020, 2020)
