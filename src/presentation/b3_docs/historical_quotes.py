...
class HistoricalQuotes:
    ...
    def __init__(self):
        ...
        """
        self.__extract_use_case = ExtractHistoricalQuotesUseCase()
        self.__available_assets_use_case = GetAvailableAssetsUseCase()
    ...
    def extract(
        ...
        docs_to_extract: DocsToExtractor = CreateDocsToExtractUseCase(
    ...
    def get_available_assets(self) -> List[str]:
        ...
        return self.__available_assets_use_case.execute()
