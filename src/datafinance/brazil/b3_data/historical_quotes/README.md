...
```python
import asyncio
from datafinance.brazil.b3_data.historical_quotes.application.use_cases import ExtractHistoricalQuotesUseCaseB3
...
O módulo expõe exceções específicas em `datafinance.brazil.b3_data.historical_quotes.exceptions`:
