class InvalidFirstYear(Exception):
    def __init__(self, minimal_first_year: int, current_year: int):
        super().__init__(
            f'Invalid first year. You must provide an integer value greater than or equal to {minimal_first_year} year and less than or equal to {current_year}.'
        )
...
class InvalidLastYear(Exception):
    def __init__(self, first_year: int, current_year: int):
        super().__init__(
            f'Invalid last year. You must provide an integer value greater than or equal to the {first_year} year and less than or equal to {current_year}.'
        )
