...
class ParquetExtractorAdapterCVM(FileExtractorRepositoryCVM):
    ...
    def extract(self, source_path: str, destination_path: str) -> None:
        ...
        Example:
            ...
            >>> extractor.extract("/data/dfp_2023/dfp_cia_aberta_2023.zip", "/data/dfp_2023/")
    ...
    def __extract_with_transaction(self, zip_path: str, destination_path: str) -> None:
        ...
        # Output directory is the destination path
