...
class GetAvailableYearsUseCase:
    ...
    def execute(self) -> Dict[str, int]:
        ...
        try:
            years_info = {
                "Geral Docs": self._available_years.get_minimal_geral_year(),
                "ITR Documents": self._available_years.get_minimal_itr_year(),
                "CGVN and VLMO Documents": self._available_years.get_minimal_cgvn_vlmo_year(),
                "Current Year": self._available_years.get_atual_year(),
            }
