...
class DocsToExtractorBuilder:
    """Builder for creating DocsToExtractorB3 entities.

    This builder provides a fluent interface for constructing DocsToExtractorB3
    ...
    def build(self) -> DocsToExtractorB3:
        """Build the DocsToExtractorB3 entity.
