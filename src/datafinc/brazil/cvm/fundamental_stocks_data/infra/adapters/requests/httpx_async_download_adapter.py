...
class HttpxAsyncDownloadAdapterCVM(DownloadDocsCVMRepositoryCVM):
    """Asynchronous download adapter using httpx."""

    def __init__(
        self,
        file_extractor_repository: FileExtractorRepositoryCVM,
        ...
        logger.debug(
            f"HttpxAsyncDownloadAdapterCVM initialized with max_concurrent={max_concurrent}, "
    ...
    def download_docs(
        ...
        Returns:
            DownloadResultCVM containing aggregated success/error information.
        """
    ...
    def retry_failed_extractions(self, destination_path: str) -> DownloadResultCVM:
        ...
        Returns:
            DownloadResultCVM with retry results
