...
**Schema note**: Use `openspec status --change "<name>" --json` and the available context files as the source of truth. Verification must compare implementation with artifacts, not only with task checkboxes.
