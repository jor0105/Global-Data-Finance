...
| Run CVM/B3 smoke checks                    | `uv run python examples/smoke_cvm.py` / `uv run python examples/smoke_b3.py`                                               |
| Capture public API surface                 | `uv run python examples/capture_api_surface.py`                                                                           |
...
| [`examples/README.md`](examples/README.md) · [`examples/01_quickstart_cvm.py`](examples/01_quickstart_cvm.py) · [`examples/02_quickstart_b3.py`](examples/02_quickstart_b3.py) · [`examples/03_opcoes_avancadas_b3.py`](examples/03_opcoes_avancadas_b3.py) · [`examples/smoke_cvm.py`](examples/smoke_cvm.py) · [`examples/smoke_b3.py`](examples/smoke_b3.py) · [`examples/capture_api_surface.py`](examples/capture_api_surface.py) | Examples and operational checks | Runnable user onboarding scripts, deterministic source-flow and public-API evidence |
